...
- **Tests**: `npm run test:run` (Vitest, 253 tests)
...
- When changing anything on the AI's hot path, capture `npm run ai:trace` before and after:
  matching hashes prove the change is pure performance. See `docs/code_architecture.md` §4.7.
