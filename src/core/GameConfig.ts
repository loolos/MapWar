export const GameConfig = {
    ...
    UI: {
        ...
        TUTORIAL_OVERLAY_DEPTH: 1200,
        TUTORIAL_OVERLAY_ALPHA: 0.6,
        TUTORIAL_HIGHLIGHT_PADDING: 8,
        TUTORIAL_HIGHLIGHT_THICKNESS: 3,
        TUTORIAL_TEXT_WIDTH_RATIO: 0.7,
        TUTORIAL_TEXT_MIN_WIDTH: 240,
        TUTORIAL_TEXT_MAX_WIDTH: 540,
        TUTORIAL_TEXT_PADDING: 12,
        TUTORIAL_TEXT_FONT_SIZE: 18,
        TUTORIAL_TEXT_OFFSET_Y: 80,
